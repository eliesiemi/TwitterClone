...
class TwitterAPICaller: BDBOAuth1SessionManager {
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "brLvsXucm8DcZwqgfbkyTb18g", consumerSecret: "ZdFF6Oz0NFITLz2zT1Pd3edJp3fmNiKyXWbMwVzDZYAd9Zesw0")
    var loginSuccess: (() -> ())?
    ...
    func postTweet(tweetString:String, success:@escaping () -> (), failture:@escaping (Error) -> ()){
        ...
        }, failure: {(task: URLSessionDataTask?, error: Error) in failture(error)
